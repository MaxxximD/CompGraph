...
namespace lab6
{
    class affine
    {
        ...
        static public void ChangePolyhedron(Polyhedron polyhedron, double[,] matrix)
        {
            ...
            for (int i = 0; i < polyhedron.Vertexes.Count; ++i)
            {
                ...
                P3D newPoint = new P3D((matrixPoint[0, 0] / matrixPoint[3, 0]), (matrixPoint[1, 0] / matrixPoint[3, 0]), (matrixPoint[2, 0] / matrixPoint[3, 0]));
        ...
        public static void scaleCenter(Polyhedron polyhedron, double k)
        {
            P3D shiftPoint = polyhedron.Center();
            double shiftX = shiftPoint.x,
                   shiftY = shiftPoint.y,
        ...
        public static void rotateCenter(Polyhedron polyhedron, double angleX, double angleY, double angleZ)
        {
            P3D center = polyhedron.Center();
